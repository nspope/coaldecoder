...
M[0,2,0] = 1e-5; M[0,2,1] = 1e-5; M[0,2,2] = 1e-6; M[0,2,3] = 1e-5; M[0,2,4:] = 0
M[1,1,:5] = 15000 * 2; M[1,1,5:] = M[0,0,5:]
M[1,0,:5] = 1e-5; M[1,0,5:] = 0
M[1,2,:4] = 1e-5; M[1,2,4:] = 0
M[2,0,:4] = 1e-5; M[2,0,4:] = 0
M[2,1,:4] = 1e-5; M[2,1,4:] = 0
M[2,2,:4] = 10000 * 2; M[2,2,4:] = M[0,0,4:]
...
populations = [
  ...
  msprime.PopulationConfiguration(sample_size=args.samples, initial_size=10000),
]
